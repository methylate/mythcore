...
public:
	pConVar();
	pConVar(const char* szCVar);
	pConVar(Mythcore::CSGOSDK::ConVar * pCvar);
	pConVar(Mythcore::CSGOSDK:: ConVar* pCvar, char* newname);
...
private:
	...
	Mythcore::CSGOSDK::ConVar* m_pOriginalCVar = NULL;
	Mythcore::CSGOSDK::ConVar* m_pDummyCVar = NULL;
...
private:
	Mythcore::CSGOSDK::ConVar* m_pConVar;
